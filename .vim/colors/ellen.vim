" Copyright (c) 2011-2019 Aleksey Rybalkin
...
if &t_Co == 256
    ...
    hi Normal         ctermbg=233  ctermfg=15   cterm=none
    " e.g. tabs
    hi SpecialKey     ctermbg=233  ctermfg=240  cterm=none
    hi VertSplit      ctermbg=233  ctermfg=160  cterm=none
    hi SignColumn     ctermbg=233  ctermfg=141  cterm=none
    hi NonText        ctermbg=233  ctermfg=240  cterm=none
    ...
    " -> Menu
    hi Pmenu          ctermbg=233  ctermfg=68   cterm=none
    ...
    hi TabLineSel     ctermbg=233  ctermfg=215  cterm=bold
    "
    " -> Visual Mode
    hi Visual         ctermbg=233  ctermfg=215  cterm=none
    hi VisualNOS      ctermbg=233  ctermfg=241  cterm=none

    " -> Code
    hi Comment        ctermbg=233  ctermfg=246  cterm=none
    hi Constant       ctermbg=233  ctermfg=33   cterm=none
    hi String         ctermbg=233  ctermfg=166  cterm=none
    hi Error          ctermbg=233  ctermfg=7    cterm=none
    hi Identifier     ctermbg=233  ctermfg=106  cterm=none
    hi Function       ctermbg=233  ctermfg=119  cterm=none
    hi Ignore         ctermbg=233  ctermfg=7    cterm=none
    hi MatchParen     ctermbg=94   ctermfg=7    cterm=none
    hi PreProc        ctermbg=233  ctermfg=196  cterm=none
    hi Special        ctermbg=233  ctermfg=93   cterm=none
    hi Todo           ctermbg=233  ctermfg=160  cterm=none
    hi Underlined     ctermbg=233  ctermfg=7    cterm=none
    hi Statement      ctermbg=233  ctermfg=175  cterm=none
    hi Operator       ctermbg=233  ctermfg=226  cterm=none
    hi Delimiter      ctermbg=233  ctermfg=7    cterm=none
    hi Type           ctermbg=233  ctermfg=111  cterm=none
    hi Exception      ctermbg=233  ctermfg=198  cterm=none
...
elseif &t_Co == 8
    ...
    " -> Folding
    hi FoldColumn     ctermbg=233  ctermfg=1    cterm=none
    hi Folded         ctermbg=233  ctermfg=1    cterm=none

    " -> Line info
    hi LineNr         ctermbg=233  ctermfg=7    cterm=none
    hi StatusLine     ctermbg=233  ctermfg=7    cterm=none
    hi StatusLineNC   ctermbg=233  ctermfg=7    cterm=none
    ...
    " -> Diff
    hi DiffAdd        ctermbg=233  ctermfg=2    cterm=none
    hi DiffChange     ctermbg=233  ctermfg=6    cterm=none
    hi DiffDelete     ctermbg=233  ctermfg=4    cterm=none
    hi DiffText       ctermbg=1    ctermfg=6    cterm=underline

    " -> Menu
    hi Pmenu          ctermbg=233  ctermfg=4    cterm=none
    ...
    " -> Visual Mode
    hi Visual         ctermbg=233  ctermfg=6    cterm=none
    hi VisualNOS      ctermbg=233  ctermfg=7    cterm=none
